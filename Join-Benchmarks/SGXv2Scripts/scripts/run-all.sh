...
numactl --physcpubind=0-31 python3 paper-4-rho-numa.py run rho-numa
...
numactl --physcpubind=0-15 --membind=0 python3 paper-9-unroll-reorder-improvements.py run unroll-reorder-improvements-mitigation
