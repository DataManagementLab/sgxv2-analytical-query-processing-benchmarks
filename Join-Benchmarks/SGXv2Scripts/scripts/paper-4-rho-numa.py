...
def carsten_plot(filename_detail):
    ...
    hypothetical_native = data[data["Setup"] == "Native Join local"].copy()
    hypothetical_native["value"] *= 2
    hypothetical_native["Setup"] = NAMES[3]
    ...
    colors = [sns.color_palette("deep")[2]] * 3 + [sns.color_palette("deep")[0]]
