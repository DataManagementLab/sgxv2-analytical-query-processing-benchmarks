...
#define CACHELINEPADDING(PARTFANOUT) ((PARTFANOUT) * CACHE_LINE_SIZE/sizeof(struct row_t))
#endif
...
#define RELATION_PADDING(NTHREADS, PARTFANOUT) ((NTHREADS) * CACHELINEPADDING(PARTFANOUT) * sizeof(struct row_t))
#endif
...
#define MWAY_MERGE_BUFFER_SIZE_DEFAULT L3_CACHE_SIZE /* 8MB L3 cache as default value */
#endif

/** Number of tuples that fits into a single cache line */
#ifndef TUPLESPERCACHELINE
#define TUPLESPERCACHELINE (CACHE_LINE_SIZE/sizeof(struct row_t))
#endif
