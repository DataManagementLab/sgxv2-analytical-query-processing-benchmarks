...
#ifndef NUM_RADIX_BITS_OLD
#define NUM_RADIX_BITS_OLD 10
#endif

/** number of passes in multipass partitioning, currently fixed at 2. */
#ifndef NUM_PASSES_OLD
#define NUM_PASSES_OLD 1
#endif
...
/** number of tuples fitting into L2 */
#define L2_CACHE_TUPLES (L2_CACHE_SIZE/sizeof(struct row_t))
...
#define THRESHOLD2(NTHR) (NTHR*L2_CACHE_TUPLES)
...
/* num-parts at pass-1 */
#define FANOUT_PASS1_OLD (1 << (NUM_RADIX_BITS_OLD/NUM_PASSES_OLD))
/* num-parts at pass-1 */
#define FANOUT_PASS2_OLD (1 << (NUM_RADIX_BITS_OLD-(NUM_RADIX_BITS_OLD/NUM_PASSES_OLD)))
...
#define PADDING_TUPLES_OLD (SMALL_PADDING_TUPLES*(FANOUT_PASS2_OLD+1))

/** @warning This padding must be allocated at the end of relation */
#ifndef RELATION_PADDING_OLD
#define RELATION_PADDING_OLD (PADDING_TUPLES_OLD*FANOUT_PASS1_OLD*sizeof(struct row_t))
#endif
