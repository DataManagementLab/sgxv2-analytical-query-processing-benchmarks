...
main(int argc, char *argv[]) {
    ...
    load_orders_from_file(&o, params.query, params.scale);
    store_orders(o, params.scale);
    free_orders(&o, params.query);

    load_customer_from_file(&c, params.query, params.scale);
    store_customers(c, params.scale);
    free_customer(&c, params.query);

    load_part_from_file(&p, params.query, params.scale);
    store_parts(p, params.scale);
    free_part(&p, params.query);

    load_nation_from_file(&n, params.query, params.scale);
    store_nations(n, params.scale);
    free_nation(&n, params.query);

    load_lineitem_from_file(&l, params.query, params.scale);
    store_lineitem(l, params.scale);
    free_lineitem(&l, params.query);
}