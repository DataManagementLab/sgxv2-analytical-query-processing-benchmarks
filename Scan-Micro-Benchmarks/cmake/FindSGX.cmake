...
cmake_minimum_required(VERSION 3.14) # target_include_directories
...
if(SGX_FOUND)
    ...
    if(SGX_MODE STREQUAL "Debug")
        ...
        set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -O0 -march=native")
    elseif(SGX_MODE STREQUAL "PreRelease")
        message(STATUS "SGX PreRelease Mode")
        set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -g -march=native")
    ...
    function(add_enclave_library target)
        ...
        if(${SGX_USE_SGXSSL})
            ...
            target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                ...
                -Wl,--start-group ${TLIB_LIST} -lsgx_tsgxssl -lsgx_tsgxssl_crypto -lsgx_tprotected_fs -lsgx_tstdc -lsgx_pthread -lsgx_tcxx -lsgx_tkey_exchange -lsgx_tcrypto -l${SGX_TSVC_LIB} -Wl,--end-group \
                -Wl,-Bstatic -Wl,-Bsymbolic -Wl,--no-undefined \
                -Wl,-pie,-eenclave_entry -Wl,--export-dynamic \
                ${LDSCRIPT_FLAG} \
                -Wl,--defsym,__ImageBase=0")
