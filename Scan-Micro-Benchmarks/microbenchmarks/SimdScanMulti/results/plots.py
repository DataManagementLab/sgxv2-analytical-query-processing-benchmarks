...
def paper_plot_cache_scan():
    ...
    data["Setting"].replace({"enclavepreload": "SGX Data in Enclave",
                             "enclavenoPreload": "SGX Data outside Enclave",
                             "nativenoPreload": "Plain CPU"},
                            inplace=True)
    ...
    out_enclave = means["SGX Data outside Enclave"]
    in_enclave = means["SGX Data in Enclave"]
    ...
    out_enclave_relative["Setting"] = "SGX Data outside Enclave"
    in_enclave_relative["Setting"] = "SGX Data in Enclave"
    ...
    ax1 = sns.lineplot(relative, x="Data Size", y="Relative", hue="Setting", style="Setting",
                       hue_order=["SGX Data outside Enclave", "SGX Data in Enclave"],
                       style_order=["SGX Data outside Enclave", "SGX Data in Enclave"], markers=True,
    ...
    ax2 = sns.lineplot(data, x="Data Size", y="Scan Throughput in GiB/s", hue="Setting", style="Setting",
                       ...
                       style_order=["Plain CPU", "SGX Data outside Enclave", "SGX Data in Enclave"], markers=True,
                       errorbar="sd", ax=ax2)
...
def plot_no_cache_scan():
    ...
    plot = sns.lineplot(data, x="Data Size", y="Scan Throughput in GiB/s", hue="Setting", style="Setting",
                        hue_order=["SGX Data in Enclave", "SGX Data outside Enclave", "Plain CPU"],
                        style_order=["SGX Data in Enclave", "SGX Data outside Enclave", "Plain CPU"], markers=True)
...
def paper_figure_multithreading():
    ...
    plot = sns.barplot(data, y="Scan Throughput in GiB/s", x="Threads", hue="Setting",
                       hue_order=["Plain CPU", "SGX Data outside Enclave", "SGX Data in Enclave"], errorbar="sd")
    plt.ylim(bottom=0)
    plt.tight_layout()
