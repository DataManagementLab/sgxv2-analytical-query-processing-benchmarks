...
void histogram(const row *data, uint32_t data_size, uint64_t mask, uint64_t shift, uint32_t *hist, uint64_t *hist_cycle_counter);
...
void histogram_loop(const row *data, uint32_t data_size, uint64_t mask,
                    uint64_t shift, uint32_t *hist,
                    uint64_t *hist_cycle_counter);

void histogram_simd(const row *data, uint32_t data_size, uint64_t mask, uint64_t shift, uint32_t *hist,
                    uint64_t *hist_cycle_counter);

void partition(const row *data, uint32_t data_size, uint64_t mask, uint64_t shift, uint32_t *sum_hist,
