 ...
 * Scan/Perm Read/Write 32/64/128/256/512 Ptr/Index Simple/Unroll Loop.
 *
 * Scan = consecutive scanning, Perm = walk permutation cycle.
 * Read/Write = obvious
 * 32/64/128/256/512 = size of access
...
REGISTER(ScanWrite64IndexUnrollLoop, 8, 8, 16);
...
REGISTER(ScanRead64IndexUnrollLoop, 8, 8, 16);
...
REGISTER(cSkipWrite64PtrSimpleLoop, 8, 8, 1);
...
REGISTER(SkipWrite64PtrSimpleLoop, 8, 8, 1);
#endif
...
REGISTER_CPUFEAT(ScanWrite512PtrSimpleLoop, "avx512", 64, 64, 1);
...
REGISTER_CPUFEAT(ScanWrite512PtrUnrollLoop, "avx512", 64, 64, 16);
...
REGISTER_CPUFEAT(ScanRead512PtrSimpleLoop, "avx512", 64, 64, 1);
...
REGISTER_CPUFEAT(ScanRead512PtrUnrollLoop, "avx512", 64, 64, 16);
